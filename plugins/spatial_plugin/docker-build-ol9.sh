...
docker run --rm --network=host \
    -v "$PROJECT_ROOT/mysql960.source:/build/mysql960.source:ro" \
    -v "$PROJECT_ROOT/mysql960:/build/mysql960:ro" \
...
g++ -shared -fPIC -std=c++17 -O2 -fvisibility=hidden -DMYSQL_DYNAMIC_PLUGIN \
    -I /build/mysql960.source/build/include \
    -I /build/mysql960/include \
    -I /build/mysql960.source/include \
    -I /build/mysql960.source \
    -I /build/mysql960.source/build \
    -I /build/mysql960.source/extra/boost/boost_1_87_0 \
    ...
    -L /build/mysql960/lib -lmysqlservices \
